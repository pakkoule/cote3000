# Cotation 3000 V8.0.28 DEV

Version de développement splittée de Cotation 3000, prête pour GitHub + Netlify.

## V8.0.28 — correctif boutons Ajouter des gros référentiels
...
## V8.0.28 DEV — édition fiabilisée + base des villes
...
### V8.0.28 — correctif boutons Modifier base des villes
...
## V8.0.28 — synchro des communes ajoutées
